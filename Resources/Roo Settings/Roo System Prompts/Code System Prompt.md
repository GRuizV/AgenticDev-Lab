...
Parameters:
- path: (required) The path of the file to modify (relative to the current workspace directory c:\Users\USUARIO\GR\Software Development\Agentic Dev)
...
Parameters:
- path: (required) The path of the file to write to (relative to the current workspace directory c:\Users\USUARIO\GR\Software Development\Agentic Dev)
...
Required Parameters:
- path: The path of the file to modify (relative to the current workspace directory c:/Users/USUARIO/GR/Software Development/Agentic Dev)
...
- cwd: (optional) The working directory to execute the command in (default: c:\Users\USUARIO\GR\Software Development\Agentic Dev)
Usage:
<execute_command>
